--1. 기술대학교의 학과 이름과 계열을 표시하시오. 단, 출력 헤더는 "학과 명", "계열" 으로 표시하도록 한다. 
...
--(국문학과의 '학과코드'는 학과 테이블(TB_DEPARTMENT)을 조회해서 찾아 내도록 하자)/ 001
SELECT STUDENT_NAME
FROM   TB_STUDENT
...
FROM   TB_STUDENT
WHERE  STUDENT_ADDRESS LIKE '전주%' AND ENTRANCE_DATE LIKE '02%'
AND    ABSENCE_YN!='Y'
